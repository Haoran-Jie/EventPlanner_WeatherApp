...
"9": {"name": "Light rain shower (night)", "icon": "fas fa-cloud-showers-heavy text-blue"},
"10": {"name": "Light rain shower (day)", "icon": "fas fa-cloud-sun-rain text-yellow"},
"11": {"name": "Drizzle", "icon": "fas fa-cloud-rain text-gray"},
"12": {"name": "Light rain", "icon": "fas fa-cloud-rain text-gray"},
"13": {"name": "Heavy rain shower (night)", "icon": "fas fa-cloud-showers-heavy text-blue"},
"14": {"name": "Heavy rain shower (day)", "icon": "fas fa-cloud-sun-rain text-yellow"},
...
def forecast(location_id, days_in_future):
    weather_data = weather_api.get_future_day_location_forecast(location_id,days_in_future)
    location=""
    for i in location_list:
        if i['id']==str(location_id):
            location=i['name']
    return render_template('home.html', weather_data=weather_data, weather_icon_map=weather_icon_map,location=location)